...
def detector(image1, image2):
    ...
    key_point1, descrip1 = sift.detectAndCompute(image1, None)
    key_point2, descrip2 = sift.detectAndCompute(image2, None)
...
def display_output(pic1, kpt1, pic2, kpt2, best_match):
    ...
    output_image = cv2.drawMatchesKnn(pic1, kpt1, pic2,
                                      kpt2, best_match, None, flags=cv2.DrawMatchesFlags_NOT_DRAW_SINGLE_POINTS)
...
if __name__ == '__main__':
    ...
    first_image_path = 'all_souls_000002.jpg'
    second_image_path = 'all_souls_000002.jpg'
